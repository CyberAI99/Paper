...
\BUPTthesisentitlepage{%
	...
	titleEN = {面向三维光场显示的人脸光照编辑方法研究}, % 本章标题
	nameEN = {杨\char"579A杰}, % 姓名
	majorEN = {新一代电子信息科学与技术(含量子技术等)}, % 专业名称
	supervisorEN = {桑新柱}, % 导师姓名
	instituteEN = {电子工程学院} % 学院名称
